...
const ConnectNewHub = ({navigation, route}) => {
  ...
  const _getListOfWifis = (data) => {
    ...
    try {
      ...
      for (let i = 0; i < data.length; i++) {
        listOfWifis.push(
          <TouchableOpacity onPress={() => navigation.navigate('ConnectNewHubToWifi', {IoTHubWifiSSID : data[i].SSID, IoTHubId: route.params.IoTHubId})}>
  ...
  return (
    ...
    <Text style={[styles.subText, styles.subTextLT]}>Your new Central IoT Hub will use your selected Wifi to connect with all Smart Meters and Cloud System</Text>
    
    <Text style={styles.subText}>Select a wifi network for your new Central IoT Hub</Text>
